...
YT_DLP_SOCKET_TIMEOUT_SECONDS = max(1.0, _get_float("YT_DLP_SOCKET_TIMEOUT_SECONDS", 30.0))
YOUTUBE_TRANSCRIPT_TIMEOUT_SECONDS = max(
    1.0, _get_float("YOUTUBE_TRANSCRIPT_TIMEOUT_SECONDS", 30.0)
)
WHISPER_TIMEOUT_SECONDS = max(1.0, _get_float("WHISPER_TIMEOUT_SECONDS", 600.0))
...
IMAGE_ENABLE_REWRITE_RECOVERY = _get_bool("IMAGE_ENABLE_REWRITE_RECOVERY", False)
